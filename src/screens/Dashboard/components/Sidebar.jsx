...
function Sidebar(props) {
    ...
    return (
        ...
        <Col lg={appInfo.sideBarExpanded ? 2 : 1} xs={12} md={12} style={Styles.sideBar} className={'sidebar'}>
            ...
            <div className={'sidebarInner'} style={Styles.sideBarInner} >
                ...
                <Row style={Styles.sideBarItem} onClick={() => { setSelected(4) }} >
                    <div style={selected === 4 ? itemWrapper : itemWrapperVoid}>
                        <Image src={personToPerson} style={Styles.sidebarItemIcon} />
                        {appInfo.sideBarExpanded && <div style={Styles.itemText}> Blog </div>}
                    </div>
                </Row>
            ...
            <div className={'sideBarInnerMobile'} onClick={() => { toggleMenuBarDisplay() }} >
                ...
                <Col xs={11} md={11} style={{ ...Content.colCentrify, cursor: 'pointer' }} >
